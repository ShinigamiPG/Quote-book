## QuoteBook project
This application uses openlibrary.org API to add books by isbn. You can add books and log your favourite quote to remember so that you can use it in conversations to sound smart. These books and quotes are then stored in a postgresql database. All entries support CRUD operations.
To begin :
